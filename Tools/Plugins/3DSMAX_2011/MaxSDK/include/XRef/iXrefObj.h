...
class IXRefObject : public Object 
{
	public:
		...
		//! \deprecated see virtual void Init(const MaxSDK::AssetManagement::AssetUser &asset, const MSTR &oname, Object *ob, BOOL asProxy=FALSE)=0;
		MAX_DEPRECATED void Init(MSTR &fname, MSTR &oname, Object *ob, BOOL asProxy=FALSE);
		...
		//! deprecated see virtual void SetFile(const MaxSDK::AssetManagement::AssetUser &asset, BOOL proxy=FALSE, BOOL update=TRUE)=0;
		MAX_DEPRECATED void SetFileName(MCHAR *name, BOOL proxy=FALSE, BOOL update=TRUE);
		...
		//! \deprecated see virtual const MaxSDK::AssetManagement::AssetUser& GetFile(BOOL proxy=FALSE)=0;
		MAX_DEPRECATED MSTR GetFileName(BOOL proxy=FALSE);
		...
		//! \deprecated see const MaxSDK::AssetManagement::AssetUser& GetCurFile()=0; AND void SetCurFile(const MaxSDK::AssetManagement::AssetUser&)=0;
		MAX_DEPRECATED MSTR &GetCurFileName();
...
{
public:
	//! \deprecated see virtual const MaxSDK::AssetManagement::AssetUser& GetActiveFile() const = 0;
	MAX_DEPRECATED const MCHAR* GetActiveFileName() const;
