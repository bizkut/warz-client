...
public:
	...
	*/
	...
	//! \deprecated : see SetRecordSrcFile(IObjXRefRecord& xrefRecord, const MaxSDK::AssetManagement::AssetUser& srcFileName)
	MAX_DEPRECATED bool SetRecordSrcFile(IObjXRefRecord& xrefRecord, const TCHAR* srcFileName);
	...
	*/
	...
	//! \deprecated : see AddXRefItemsFromFile(const MaxSDK::AssetManagement::AssetUser& srcFileName, bool promptObjNames, const Tab<MCHAR*>* objNames, unsigned int xrefOptions)
	MAX_DEPRECATED IObjXRefRecord* AddXRefItemsFromFile(
		const TCHAR* srcFileName, bool promptObjNames, const Tab<TCHAR*>* objNames, unsigned int xrefOptions);
	...
	*/
	...
	//! \deprecated : see SetXRefItemSrcFile(ReferenceTarget& xrefItem, const MaxSDK::AssetManagement::AssetUser& srcAsset)
	MAX_DEPRECATED bool SetXRefItemSrcFile(ReferenceTarget& xrefProxy, const TCHAR* proxyFileName);
	...
	*/
	...
	//! \deprecated : see SetProxyItemSrcFile(ReferenceTarget& xrefProxy, const MaxSDK::AssetManagement::AssetUser& proxyAsset)
	MAX_DEPRECATED bool SetProxyItemSrcFile(ReferenceTarget& xrefProxy, const TCHAR* proxyFileName);
	...
	*/
	...
	private:
		...
		virtual bool FPSetXRefItemSrcFile(ReferenceTarget& xrefItem, const TCHAR* fname)=0;
		virtual bool FPSetProxyItemSrcFile(ReferenceTarget& xrefProxy, const TCHAR* fname)=0;
}; 
