...
class IObjXRefManager : public FPStaticInterface 
{
	...
	//! \deprecated : see virtual IXRefObject *AddXRefObject(const MaxSDK::AssetManagement::AssetUser &asset, MCHAR *obname, int xFlags = 0)=0;
	MAX_DEPRECATED IXRefObject *AddXRefObject(MCHAR *fname, MCHAR *obname, int xFlags = 0);
	...
	//! \deprecated see virtual int GetNumXRefObjects(const MaxSDK::AssetManagement::AssetUser &asset)=0;
	MAX_DEPRECATED int GetNumXRefObjects(MCHAR *fname);
	...
	//! \deprecated : see virtual IXRefObject *GetXRefObject(const MaxSDK::AssetManagement::AssetUser &asset, int i)=0;
	MAX_DEPRECATED IXRefObject *GetXRefObject(MCHAR *fname, int i);
	...
	//! deprecated : see virtual const MaxSDK::AssetManagement::AssetUser &GetFile(int fidx)=0;
	MAX_DEPRECATED MCHAR *GetFileName(int fidx);
	...
	//! \deprecated : see virtual BOOL ReloadFile(const MaxSDK::AssetManagement::AssetUser &asset)=0;
	MAX_DEPRECATED BOOL ReloadFile(MCHAR *fname);
	...
	//! \deprecated : see virtual BOOL IsFileUnresolved(const MaxSDK::AssetManagement::AssetUser &asset)=0;
	MAX_DEPRECATED BOOL IsFileUnresolved(MCHAR *fname);
	...
	//! deprecated : see virtual BOOL IsFileDisabled(const MaxSDK::AssetManagement::AssetUser &asset)=0;
	MAX_DEPRECATED BOOL IsFileDisabled(MCHAR *fname);
