...
public:
	...
	*/
	...
	//! \deprecated : see virtual const MaxSDK::AssetManagement::AssetUser& GetSrcFile() const = 0;
	MAX_DEPRECATED const MCHAR* GetSrcFileName() const;
	...
	*/
	...
	virtual const TSTR& GetParentSrcFileName()const = 0;
	//@}
