...
public:
	...
	//! deprecated: see virtual const MaxSDK::AssetManagement::AssetUser& GetPresetFile() = 0;
	MAX_DEPRECATED const MCHAR*	GetPreset();
	...
	//! deprecated : see virtual void SetPresetFile(const MaxSDK::AssetManagement::AssetUser& preset) = 0;
	MAX_DEPRECATED void			SetPreset(const MCHAR* preset);
...
public:
	...
	//! \deprecated see: virtual void EnumAuxFiles(AssetEnumCallback& nameEnum, DWORD flags = FILE_ENUM_ALL) = 0;
