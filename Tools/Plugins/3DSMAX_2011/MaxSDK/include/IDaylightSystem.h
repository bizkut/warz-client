...
#define IDD_DAYLIGHT_SYSTEM_FACTORY2 Interface_ID(0x688f66a6, 0x423a37aa)
#pragma deprecated("IDD_DAYLIGHT_SYSTEM_FACTORY2")
...
public:
	...
	*/
	...
	/** \name Weather Data File 
	 * Methods dealing with using weather data files that may control the daylight system
	*/
	//@{

	/*! \brief deprecated: use virtual MaxSDK::AssetManagement::AssetUser GetWeatherFile()const =0;
	*/
	MAX_DEPRECATED MSTR GetWeatherFileName()const;
	...
	*/
	...
	/*!\brief deprecated: use virtual void SetWeatherFile(const MaxSDK::AssetManagement::AssetUser &val) =0;
	*/
	MAX_DEPRECATED void SetWeatherFileName(MSTR &val);
