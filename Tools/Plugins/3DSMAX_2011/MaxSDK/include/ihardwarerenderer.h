...
public:
	...
	*/
	...
	/*! \deprecated This method is no longer supported.  The DWORD_PTR must now be a pointer GFX_MESH::IHWDrawMesh class.  See HWMesh.h for more details.*/
	MAX_DEPRECATED BOOL D3DHWMeshCacheManagerAddHWMesh( INode *node, DWORD_PTR pMesh, Material *mtl, HardwareMaterial *pHWMat, Point3 wireframeColor, Matrix3 *tmOverRide, DWORD attr, DWORD renderLimit);
