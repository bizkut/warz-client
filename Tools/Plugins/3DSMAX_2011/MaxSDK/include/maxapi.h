...
//watje
	...
	// watje Gets/Sets the selection filter
		...
		*/
		...
		/*! \remarks This invalidates the rectangle in the viewports that the
		...
		//! \brief Deprecated. Use int Interface::GetAssetDirCount(MaxSDK::AssetManagement::AssetType assetType) instead
		MAX_DEPRECATED int GetMapDirCount(BOOL xref=FALSE);
		...
		//! \brief Deprecated. Use const MCHAR* Interface::GetAssetDir(int i, MaxSDK::AssetManagement::AssetType assetType) instead,
		MAX_DEPRECATED const MCHAR *GetMapDir(int i, BOOL xref=FALSE);
		...
		//! \brief Deprecated. Use BOOL Interface::AddAssetDir(const MCHAR *dir, MaxSDK::AssetManagement::AssetType assetType) instead.
		MAX_DEPRECATED BOOL AddMapDir(const MCHAR *dir, BOOL xref=FALSE);
		...
		//! \brief Deprecated. Use BOOL Interface::AddSessionAssetDir(const MCHAR *dir, MaxSDK::AssetManagement::AssetType assetType,int update=TRUE) instead.
		MAX_DEPRECATED BOOL AddSessionMapDir(const MCHAR *dir, int update=TRUE, BOOL xref=FALSE);
		...
		//! \brief Deprecated. Use int Interface::GetSessionAssetDirCount(MaxSDK::AssetManagement::AssetType assetType) instead.
		MAX_DEPRECATED int GetSessionMapDirCount(BOOL xref=FALSE);
		...
		//! \brief Deprecated. Use const MCHAR* Interface::GetSessionAssetDir(int i, MaxSDK::AssetManagement::AssetType assetType) instead.
		MAX_DEPRECATED const MCHAR *GetSessionMapDir(int i, BOOL xref=FALSE);
		...
		//! \brief Deprecated. Use BOOL Interface::DeleteSessionAssetDir(int i, MaxSDK::AssetManagement::AssetType assetType, int update=TRUE) instead.
		MAX_DEPRECATED BOOL DeleteSessionMapDir(int i, int update=TRUE, BOOL xref=FALSE);
		...
		//! \brief Deprecated. Use int Interface::GetCurAssetDirCount(MaxSDK::AssetManagement::AssetType assetType) instead.
		MAX_DEPRECATED int GetCurMapDirCount(BOOL xref=FALSE);
		...
		//! \brief Deprecated. Use const MCHAR* Interface::GetCurAssetDir(int i, MaxSDK::AssetManagement::AssetType assetType) instead.
		MAX_DEPRECATED const MCHAR *GetCurMapDir(int i, BOOL xref=FALSE);		
		...
		*/
		...
		//! \deprecated see : virtual BOOL		setBkgImageAsset(const MaxSDK::AssetManagement::AssetUser& asset)=0;
		MAX_DEPRECATED BOOL		setBkgImageName(MCHAR *name);
		//! deprecated see : virtual const MaxSDK::AssetManagement::AssetUser&	getBkgImageAsset(void)=0;
		MAX_DEPRECATED const MCHAR *		getBkgImageName(void);
		...
		*/
		...
		active renderer. This will be either the production rederer or the
...
// mjm - end
	...
	//watje this zooms the active viewport or all to the specified bounding box which is in world space
		...
		*)dir)</b>\n\n
		...
		//! \deprecated see : virtual void EnumAuxFiles(AssetEnumCallback& assetEnum, DWORD flags)=0;
		MAX_DEPRECATED void EnumAuxFiles(NameEnumCallback& assetEnum, DWORD flags);
		...
		/*! \deprecated This method has been deprecated in 3ds max 2011, please use the corresponding method in INamedSelectionSetManager */
		MAX_DEPRECATED virtual int GetNumNamedSelSets() = 0;
		/*! \deprecated This method has been deprecated in 3ds max 2011, please use the corresponding method in INamedSelectionSetManager */
		MAX_DEPRECATED virtual MCHAR *GetNamedSelSetName(int setNum) = 0;
		/*! \deprecated This method has been deprecated in 3ds max 2011, please use the corresponding method in INamedSelectionSetManager */
		MAX_DEPRECATED virtual int GetNamedSelSetItemCount(int setNum) = 0;
		/*! \deprecated This method has been deprecated in 3ds max 2011, please use the corresponding method in INamedSelectionSetManager */
		MAX_DEPRECATED virtual INode *GetNamedSelSetItem(int setNum,int i) = 0;
		/*! \deprecated This method has been deprecated in 3ds max 2011, please use the corresponding method in INamedSelectionSetManager */
		MAX_DEPRECATED virtual void AddNewNamedSelSet(INodeTab &nodes,MSTR &name) = 0;
		/*! \deprecated This method has been deprecated in 3ds max 2011, please use the corresponding method in INamedSelectionSetManager */
		MAX_DEPRECATED virtual void RemoveNamedSelSet(MSTR &name) = 0;
		/*! \deprecated This method has been deprecated in 3ds max 2011, please use the corresponding method in INamedSelectionSetManager */
		MAX_DEPRECATED virtual void ReplaceNamedSelSet(INodeTab& nodes,int setNum) = 0;
		/*! \deprecated This method has been deprecated in 3ds max 2011, please use the corresponding method in INamedSelectionSetManager */
		MAX_DEPRECATED virtual void GetNamedSelSetList(INodeTab &nodes,int setNum) = 0;
		...
		MAX_DEPRECATED virtual unsigned int HardwareLockID() = 0;
		...
		MAX_DEPRECATED virtual bool IsEmergencyLicense() = 0;
...
public:
	...
	//! \brief Deprecated. Use BOOL Interface7::AddAssetDir(MCHAR *dir, MaxSDK::AssetManagement::AssetType assetType, int update=TRUE) instead.
	MAX_DEPRECATED BOOL AddMapDir(MCHAR *dir, int update=TRUE, BOOL xref=FALSE);
	...
	//! \brief Deprecated. Use BOOL Interface7::DeleteAssetDir(int i, MaxSDK::AssetManagement::AssetType assetType,int update=TRUE) instead.
	MAX_DEPRECATED BOOL DeleteMapDir(int i, int update=TRUE, BOOL xref=FALSE);
	...
	//! \brief Deprecated. Use void Interface7::UpdateAssetSection(MaxSDK::AssetManagement::AssetType assetType) instead.
	MAX_DEPRECATED void UpdateMapSection(BOOL xref=FALSE);
	...
	/// --- XRefs ----------------------------------------------------------- ///
	//! \deprecated : see virtual	void ConvertFlagedNodesToXRefs(	const MaxSDK::AssetManagement::AssetUser &fname, etc.
	MAX_DEPRECATED	void ConvertFlagedNodesToXRefs(
		MSTR &fname,
		INode *rootNode,
		Tab<INode*> &nodes, 
		int xFlags);
...
public:
	...
	//! \deprecated see : virtual const MaxSDK::AssetManagement::AssetUser& GetPreRendScript()=0;
	MAX_DEPRECATED MSTR GetPreRendScript();
	...
	//! \deprecated see : virtual void SetPreRendScript( const MaxSDK::AssetManagement::AssetUser& script )=0;
	MAX_DEPRECATED void SetPreRendScript( const MSTR& script );
	...
	//! \deprecated : see virtual const MaxSDK::AssetManagement::AssetUser& GetPostRendScript()=0;
	MAX_DEPRECATED MSTR GetPostRendScript();
	...
	//! \deprecated see : virtual void SetPostRendScript( const MaxSDK::AssetManagement::AssetUser& script )=0;
	MAX_DEPRECATED void SetPostRendScript( const MSTR& script );
...
public:
	...
	virtual ClassDesc *DoPickClassDlg(HWND hParent, TCHAR *title, SClass_ID super, PickClassCallback *pPickClassCB = NULL) = 0;
	...
	virtual int DoMultiplePickClassDlg(HWND hParent, TCHAR *title, SClass_ID super, PickClassCallback *pPickClassCB, Tab<ClassDesc *> *classDescTab) = 0;
