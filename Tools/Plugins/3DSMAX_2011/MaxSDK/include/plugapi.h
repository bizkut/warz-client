...
/**
\defgroup 3dsMaxRelease 3ds Max Release identifiers
*/
//@{
//!\brief Represents an unsupported 3ds Max version. 
...
//    255:     temporary use to prevent NOVA plugins from loading in MAX
	...
	#define MAX_API_NUM_R130_BETA1		34	 // R13.0 Beta 1 - SDK is compatible with Max R12 and Max R13 Alpha builds (except for new APIs added in R13)
	#define MAX_API_NUM_R130					35	 // R13.0 Release - SDK is compatible with Max R12 and Max R13 Alpha and Beta builds (except for new APIs added in R13)
	#define MAX_API_NUM								MAX_API_NUM_R130
...
#define ASSOC_CLASS_ID				0x001120 //!< \deprecated Superclass id not supported by 3ds Max
#define GLOBAL_ASSOC_CLASS_ID		0x001130 //!< \deprecated Superclass id not supported by 3ds Max
...
#pragma deprecated("ASSOC_CLASS_ID")
#pragma deprecated("GLOBAL_ASSOC_CLASS_ID")
...
#define DMTL2_CLASS_ID  		0x00000003	// Not used (was used when migrating from StdMtl to StdMtl2)
...
//! \brief Class ID for locked materials
