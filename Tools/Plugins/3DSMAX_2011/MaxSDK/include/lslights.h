...
//    for B24 of VIZ R4
	...
	//! \deprecated use : virtual MaxSDK::AssetManagement::AssetUser GetWebFile( ) const = 0;
	MAX_DEPRECATED const MCHAR* GetWebFileName( ) const;
	//@{
	...
	//! /deprecated use : virtual void SetWebFile( const MaxSDK::AssetManagement::AssetUser& name ) = 0;
	MAX_DEPRECATED void SetWebFileName( const MCHAR* name );
