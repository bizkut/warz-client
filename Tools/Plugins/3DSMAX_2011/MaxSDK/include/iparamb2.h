...
#define animatable_type(t) (base_type(t) == TYPE_INT || base_type(t) == TYPE_RGBA ||  base_type(t) == TYPE_HSV || base_type(t) == TYPE_POINT3 || \
							...
							base_type(t) == TYPE_INDEX  || base_type(t) == TYPE_RADIOBTN_INDEX || base_type(t) == TYPE_FRGBA || base_type(t) == TYPE_POINT4) //!< \deprecated IsParamTypeAnimatable should be used instead.
#pragma deprecated("animatable_type")
...
class IParamBlock2 : public ReferenceTarget 
{
	public:
		...
		*elem2);</b>\n\n
		...
		/*! \remarks Checks to see if a keyframe exists for the given
		parameter at the given time
		...
		/*! \remarks Removes the 'i-th' controller.
		...
		/*! \remarks Returns a pointer to the controller of the specified
		parameter.
		\param id The permanent ID of the parameter.
		\param tabIndex If the parameter is a table this is the zero based index of the element
		...
		/*! \remarks Sets the 'i-th' parameter controller to the one
		specified.
		\param i Specifies which controller using the zero based index of the parameter
		in the block.
		\param tabIndex If the parameter is a table this is the zero based index of the element
		...
		/*! \remarks Swaps the two controllers of the parameters whose indices are passed.
...
private:
  ...
  va_list scan_option(va_list ap, int tag, ParamDef* p, MCHAR* parm_name, int& optionnum);
	// Verifies integrity of the param block desc
...
/*! \remarks This function creates a new ParamBlock2, based on an existing
