...
class MtlBase: public ReferenceTarget, public ISubMap {
	...
	public:
			...
			*/
			...
			//! \deprecated see :CoreExport void EnumAuxFiles(AssetEnumCallback& nameEnum, DWORD flags);
			MAX_DEPRECATED void EnumAuxFiles(NameEnumCallback& nameEnum, DWORD flags);
