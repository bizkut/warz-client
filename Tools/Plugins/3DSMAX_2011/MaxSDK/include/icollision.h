...
//	void SetTM(TimeValue t, Matrix3 tm)	 { pblock->SetValue(collisionplane_tm,t,&tm); }
	...
	\par Default Implementation:
	<b>{ pblock-\>SetController(collisionplane_width,0,c); }</b> */
	...
	A pointer to the controller to set.
	\par Default Implementation:
	<b>{ pblock-\>SetController(collisionplane_height,0,c); }</b> */
	...
	A pointer to the controller to set.
	\par Default Implementation:
	<b>{ pblock-\>SetController(collisionplane_quality,0,c); }</b> */
...
//access functions to the pblock
	...
	\par Default Implementation:
	<b>{ pblock-\>SetController(collisionsphere_radius,0,c); }</b> */
