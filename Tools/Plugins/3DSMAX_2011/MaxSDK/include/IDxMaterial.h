...
public:
	...
	*/
	...
	//! \deprecated : see virtual const MaxSDK::AssetManagement::AssetUser&  GetEffectFile() = 0;
	MAX_DEPRECATED MCHAR*  GetEffectFilename();
	...
	*/
	...
	//! \deprecated : see virtual void SetEffectFile(const MaxSDK::AssetManagement::AssetUser& file) = 0;
	MAX_DEPRECATED void SetEffectFilename(MCHAR * filename);
