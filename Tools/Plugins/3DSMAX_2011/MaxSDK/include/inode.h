...
class INode: public ReferenceTarget, public FPMixinInterface {
	public:
		...
		*/
		...
		//! \deprecated : see virtual MaxSDK::AssetManagement::AssetUser GetXRefFile(int i) {return MaxSDK::AssetManagement::AssetUser();}
		MAX_DEPRECATED MSTR GetXRefFileName(int i) ;
		...
		//! \deprecated : see virtual void SetXRefFile(int i,const MaxSDK::AssetManagement::AssetUser& file,BOOL reload) {}
		MAX_DEPRECATED void SetXRefFileName(int i,MCHAR *fname,BOOL reload);
		...
		//! \deprecated : see virtual BOOL AddNewXRefFile(const MaxSDK::AssetManagement::AssetUser &file, BOOL loadNow=TRUE, BOOL hideInManagerUI=FALSE) {return FALSE;}
		MAX_DEPRECATED BOOL AddNewXRefFile(MSTR &name, BOOL loadNow=TRUE, BOOL hideInManagerUI=FALSE);
