...
#define FLOAT_WIRE_CONTROL_CNAME		_M("Float Wire") //GetString(IDS_RB_WIREFLOAT)
#define FLOAT_WIRE_CONTROL_CLASS_ID		Class_ID(0x498702e7, 0x71f11549)

#define POSITION_WIRE_CONTROL_CNAME		_M("Position Wire") //GetString(IDS_RB_WIREPOSITION)
#define POSITION_WIRE_CONTROL_CLASS_ID	Class_ID(0x5065767c, 0x683a42a6)

#define POINT3_WIRE_CONTROL_CNAME		_M("Point3 Wire") //GetString(IDS_RB_WIREPOINT3)
#define POINT3_WIRE_CONTROL_CLASS_ID	Class_ID(0x4697286a, 0x2f7f05cf)

#define ROTATION_WIRE_CONTROL_CNAME		_M("Rotation Wire") //GetString(IDS_RB_WIREROTATION)
#define ROTATION_WIRE_CONTROL_CLASS_ID	Class_ID(0x31381913, 0x3a904167)

#define SCALE_WIRE_CONTROL_CNAME		_M("Scale Wire") //GetString(IDS_RB_WIRESCALE)
