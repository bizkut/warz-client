...
//! \brief Deprecated. The dropdown is now in the render dialog, not the main toolbar.
/* \see Interface7::GetRenderType, Interface7::SetRenderType */
#define TOOLBUT_RENDER_TYPE			28
#pragma deprecated("TOOLBUT_RENDER_TYPE")
