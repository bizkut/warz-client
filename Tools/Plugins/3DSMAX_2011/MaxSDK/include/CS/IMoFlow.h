...
class Snippet: public MaxHeapOperators {
  ...
  public:
	...
	//! deprecated: see inline const MaxSDK::AssetManagement::AssetUser& GetFile();
	MAX_DEPRECATED 	const MCHAR* GetFileName();
	//! deprecated: see void SetFile(const MaxSDK::AssetManagement::AssetUser& assetUser);
	MAX_DEPRECATED 	void SetFileName(const MCHAR* n);
