...
public:
	...
	//! \deprecated see : virtual void SetCombustionOutput(const MaxSDK::AssetManagement::AssetUser& combustionOutputPath) = 0;
	MAX_DEPRECATED void SetCombustionOutputPath(const MCHAR *combustionOutputPath);
	//! \deprecated see : virtual void SetCombustionOutput(const MaxSDK::AssetManagement::AssetUser& combustionOutputPath) = 0;
	MAX_DEPRECATED void SetCombustionOutputPath(const MSTR& combustionOutputPath);
	//! \deprecated see : virtual const MaxSDK::AssetManagement::AssetUser& GetCombustionOutput() const = 0;
	MAX_DEPRECATED const MSTR& GetCombustionOutputPath() const;
