...
public:
	...
	//! \deprecated see : virtual MaxSDK::AssetManagement::AssetUser GetAsset() const = 0;
	...
	//! \deprecated see : virtual bool SetAsset(const MaxSDK::AssetManagement::AssetUser& aNewAssetUser) = 0;
	MAX_DEPRECATED void SetPath(const MaxSDK::Util::Path& aNewPath);
