...
public:
	...
	//! \deprecated see: virtual bool Initialize(const MaxSDK::AssetManagement::AssetUser & effect, EffectSource input)=0;
	MAX_DEPRECATED bool Initialize(MCHAR * effect, EffectSource input);
	...
	//! \deprecated see: virtual const MCHAR * GetEffectFileName() = 0;
	MAX_DEPRECATED const MCHAR * GetEffectFileName();
