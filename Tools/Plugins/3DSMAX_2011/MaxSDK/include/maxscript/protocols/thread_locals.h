...
#pragma warning(disable:4100)
	...
	def_thread_local( UINT_PTR,	source_pos,					0);				// current pos in source file
	def_thread_local( UINT_PTR,	source_line,				0);				// current pos in source file, instead of INT_PTR, will have an int to simplify things
	...
	def_thread_local( UINT_PTR,	err_source_pos,				0);				// pos in source file where error thrown
	def_thread_local( UINT_PTR,	err_source_line,			0);				// line in source file where error thrown
