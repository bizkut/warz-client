...
//! \brief Deprecated in Max 2011.
/*!	Use DEFINE_LOCAL_GENERIC_CLASS( _rootClass, _cls ) instead.
	New macro found in <maxscript/macros/generic_class.h> */
#define define_local_generic_class 													\
	MS_LOCAL_GENERIC_CLASS::MS_LOCAL_GENERIC_CLASS(MCHAR*fn_name, local_value_vf fn)\
	{																				\
...
#pragma deprecated("define_local_generic_class") // Deprecated in Max 2011.

//! \brief Deprecated in Max 2011. 
/*!	Use DEFINE_LOCAL_GENERIC_CLASS_DEBUG_OK( _rootClass, _cls ) instead.
	New macro found in <maxscript/macros/generic_class.h> */
#define define_local_generic_class_debug_ok 										\
	MS_LOCAL_GENERIC_CLASS::MS_LOCAL_GENERIC_CLASS(MCHAR*fn_name, local_value_vf fn)\
	{																				\
		tag = MS_LOCAL_GENERIC_CLASS_TAG;											\
		fn_ptr = fn;																\
	...
	MS_LOCAL_GENERIC_CLASS_CLASS MS_LOCAL_GENERIC_CLASS_class (str1(MS_LOCAL_GENERIC_CLASS));
#pragma deprecated("define_local_generic_class_debug_ok") // Deprecated in Max 2011.
