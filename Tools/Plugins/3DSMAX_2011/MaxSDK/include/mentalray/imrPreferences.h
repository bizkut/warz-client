...
public:
    ...
    //! \brief Deprecated. Functionality no longer supported.
    MAX_DEPRECATED virtual VFBClearMode GetVFBClearMode() const {return kVFBClear_All;}
    //! \brief Deprecated. Functionality no longer supported.
    MAX_DEPRECATED virtual void SetVFBClearMode(VFBClearMode mode) { UNUSED_PARAM(mode); }
    //
    // Rendering Options
    ////////////////////////////////////////////////////////////////////////////
