...
BOOL CkXml_GetAttributeName(HCkXml cHandle, long index, HCkString outStr);
BOOL CkXml_GetAttributeValue(HCkXml cHandle, long index, HCkString outStr);
...
BOOL CkXml_GetChildContentByIndex(HCkXml cHandle, long index, HCkString outStr);
...
BOOL CkXml_GetChildTag(HCkXml cHandle, long index, HCkString outStr);
