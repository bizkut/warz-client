...
BOOL CkSFtp_CopyFileAttr(HCkSFtp cHandle, const char *localFilePath, const char *remotePathOrHandle, BOOL bIsHandle);
...
int CkSFtp_GetFileSize32(HCkSFtp cHandle, const char *filePathOrHandle, BOOL bFollowLinks, BOOL bIsHandle);
__int64 CkSFtp_GetFileSize64(HCkSFtp cHandle, const char *filePathOrHandle, BOOL bFollowLinks, BOOL bIsHandle);
...
BOOL CkSFtp_SetCreateTimeStr(HCkSFtp cHandle, const char *pathOrHandle, BOOL bIsHandle, const char *createTimeStr);
...
BOOL CkSFtp_SetLastAccessTimeStr(HCkSFtp cHandle, const char *pathOrHandle, BOOL bIsHandle, const char *createTimeStr);
...
BOOL CkSFtp_SetLastModifiedTimeStr(HCkSFtp cHandle, const char *pathOrHandle, BOOL bIsHandle, const char *createTimeStr);
