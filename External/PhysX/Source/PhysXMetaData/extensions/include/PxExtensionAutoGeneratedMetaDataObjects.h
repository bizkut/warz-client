...
template<> struct PxEnumTraits< physx::PxD6Drive::Enum > { PxEnumTraits() : NameConversion( g_physx__PxD6Drive__EnumConversion ) {} const PxU32ToName* NameConversion; }; 
	...
	template<> struct PxClassInfoTraits<PxJointLimit>
	{ 
		PxJointLimitGeneratedInfo Info;
		const PxJointLimitGeneratedInfo* getInfo() { return &Info; }
	};
	...
	template<> struct PxClassInfoTraits<PxJointLimitPair>
	{ 
		PxJointLimitPairGeneratedInfo Info;
		const PxJointLimitPairGeneratedInfo* getInfo() { return &Info; }
	};
