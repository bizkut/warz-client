...
struct PxBufferCollectionPropertyInfo : public PxPropertyInfoParameterizedBase<TKey>
{
	...
	typedef PxU32 (*TGetObjectsMember)( const TObjType*, TCollectionType* );
	...
	PxU32 get( const TObjType* inObj, TCollectionType* inBuffer ) const { return mGetObjectsMember( inObj, inBuffer); }
