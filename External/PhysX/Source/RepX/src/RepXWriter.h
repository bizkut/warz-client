...
#ifndef REPX_REPXWRITER_H
#define REPX_REPXWRITER_H
...
namespace physx { namespace repx {
	...
	public:
		...
		/** Write an object reference into the current item */
		virtual void write( const char* inName, const RepXObject& inLiveObject ) = 0;
