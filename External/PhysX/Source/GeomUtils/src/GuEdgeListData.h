...
public:
	...
	PX_INLINE static Ps::IntBool	HasActiveEdge01(const Gu::EdgeTriangleData& data)			{ return data.mLink[0] & MSH_ACTIVE_EDGE_MASK;	}
	PX_INLINE static Ps::IntBool	HasActiveEdge12(const Gu::EdgeTriangleData& data)			{ return data.mLink[1] & MSH_ACTIVE_EDGE_MASK;	}
	PX_INLINE static Ps::IntBool	HasActiveEdge20(const Gu::EdgeTriangleData& data)			{ return data.mLink[2] & MSH_ACTIVE_EDGE_MASK;	}
	PX_INLINE static Ps::IntBool	HasActiveEdge(const Gu::EdgeTriangleData& data, PxU32 i)	{ return data.mLink[i] & MSH_ACTIVE_EDGE_MASK;	}
};
