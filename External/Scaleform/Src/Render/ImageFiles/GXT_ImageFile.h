...
#ifndef INC_SF_GXT_IMAGEFILE_H
#define INC_SF_GXT_IMAGEFILE_H
#pragma once
...
{
public:
    virtual ImageFileFormat GetFormat() const { return ImageFile_GXT; }
