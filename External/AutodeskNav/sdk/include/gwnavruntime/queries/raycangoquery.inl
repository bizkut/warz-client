...
KY_INLINE RayCanGoQuery<TLogic>::RayCanGoQuery() : BaseRayCanGoQuery() {}

template<class TLogic>
KY_INLINE void RayCanGoQuery<TLogic>::BindToDatabase(Database* database)
{
	BaseRayCanGoQuery::BindToDatabase(database);
}

template<class TLogic>
KY_INLINE void RayCanGoQuery<TLogic>::Initialize(const Vec3f& startPos, const Vec3f& destPos)
{
	BaseRayCanGoQuery::Initialize(startPos, destPos);
}

template<class TLogic>
KY_INLINE void RayCanGoQuery<TLogic>::SetStartTrianglePtr(const NavTrianglePtr& startTrianglePtr) { BaseRayCanGoQuery::SetStartTrianglePtr(startTrianglePtr); }
template<class TLogic>
KY_INLINE void RayCanGoQuery<TLogic>::SetStartIntegerPos(const WorldIntegerPos& startIntegerPos)  { BaseRayCanGoQuery::SetStartIntegerPos(startIntegerPos);   }
template<class TLogic>
KY_INLINE void RayCanGoQuery<TLogic>::SetDestIntegerPos(const WorldIntegerPos& destIntegerPos)    { BaseRayCanGoQuery::SetDestIntegerPos(destIntegerPos);     }
template<class TLogic>
KY_INLINE void RayCanGoQuery<TLogic>::SetQueryDynamicOutput(QueryDynamicOutput* queryDynamicOutput)
{
	BaseRayCanGoQuery::SetQueryDynamicOutput(queryDynamicOutput);
}

template<class TLogic>
KY_INLINE void RayCanGoQuery<TLogic>::SetMarginMode(RayCanGoMarginMode marginMode)        { BaseRayCanGoQuery::SetMarginMode(marginMode);           }
template<class TLogic>
KY_INLINE void RayCanGoQuery<TLogic>::SetDynamicOutputMode(DynamicOutputMode savingMode)  { BaseRayCanGoQuery::SetDynamicOutputMode(savingMode);    }
template<class TLogic>
KY_INLINE void RayCanGoQuery<TLogic>::SetComputeCostMode(ComputeCostMode computeCostMode) { BaseRayCanGoQuery::SetComputeCostMode(computeCostMode); }

template<class TLogic>
KY_INLINE void RayCanGoQuery<TLogic>::SetPositionSpatializationRange(const PositionSpatializationRange& positionSpatializationRange)
{
	BaseRayCanGoQuery::SetPositionSpatializationRange(positionSpatializationRange);
}

template<class TLogic>
KY_INLINE RayCanGoQueryResult   RayCanGoQuery<TLogic>::GetResult()              const { return BaseRayCanGoQuery::GetResult();             }
template<class TLogic>
KY_INLINE DynamicOutputMode     RayCanGoQuery<TLogic>::GetDynamicOutputMode()   const { return BaseRayCanGoQuery::GetDynamicOutputMode();  }
template<class TLogic>
KY_INLINE ComputeCostMode       RayCanGoQuery<TLogic>::GetComputeCostMode()     const { return BaseRayCanGoQuery::GetComputeCostMode();    }
template<class TLogic>
KY_INLINE KyFloat32             RayCanGoQuery<TLogic>::GetComputedCost()        const { return BaseRayCanGoQuery::GetComputedCost();       }
template<class TLogic>
KY_INLINE const Vec3f&          RayCanGoQuery<TLogic>::GetStartPos()            const { return BaseRayCanGoQuery::GetStartPos();           }
template<class TLogic>
KY_INLINE const Vec3f&          RayCanGoQuery<TLogic>::GetDestPos()             const { return BaseRayCanGoQuery::GetDestPos();            }
template<class TLogic>
KY_INLINE const NavTrianglePtr& RayCanGoQuery<TLogic>::GetStartTrianglePtr()    const { return BaseRayCanGoQuery::GetStartTrianglePtr();   }
template<class TLogic>
KY_INLINE const NavTrianglePtr& RayCanGoQuery<TLogic>::GetDestTrianglePtr()     const { return BaseRayCanGoQuery::GetDestTrianglePtr();    }
template<class TLogic>
KY_INLINE QueryDynamicOutput*   RayCanGoQuery<TLogic>::GetQueryDynamicOutput()  const { return BaseRayCanGoQuery::GetQueryDynamicOutput(); }
template<class TLogic>
KY_INLINE RayCanGoMarginMode    RayCanGoQuery<TLogic>::GetMarginMode()          const { return BaseRayCanGoQuery::GetMarginMode();         }
template<class TLogic>
KY_INLINE const WorldIntegerPos& RayCanGoQuery<TLogic>::GetStartIntegerPos()    const { return BaseRayCanGoQuery::GetStartIntegerPos();    }
template<class TLogic>
KY_INLINE const WorldIntegerPos& RayCanGoQuery<TLogic>::GetDestIntegerPos()     const { return BaseRayCanGoQuery::GetDestIntegerPos();     }

template<class TLogic>
KY_INLINE const PositionSpatializationRange& RayCanGoQuery<TLogic>::GetPositionSpatializationRange() const
{
	return BaseRayCanGoQuery::GetPositionSpatializationRange();
}

template<class TLogic>
KY_INLINE void RayCanGoQuery<TLogic>::Advance(WorkingMemory* workingMemory)
{
...
template<class TLogic>
inline void RayCanGoQuery<TLogic>::PerformQuery(WorkingMemory* workingMemory)
{
...
template<class TLogic>
inline void RayCanGoQuery<TLogic>::PerformQueryWithInputCoordPos(WorkingMemory* workingMemory)
{
	...
	// i.e. we check if dest is beyond the edge we are about to cross
			...
			currentNavFloorBlob, currentPairHalfEdgeRawPtr, pointerToCostMultiplier))
		{
			...
			if (IsHalfEdgeAFloorOrCellBoundary(currentNavHalfEdge.GetHalfEdgeType()))
			{
				...
				if (IsHalfEdgeACellBoundary(currentNavHalfEdge.GetHalfEdgeType()))
					// depending on the type (north, south, east, west) we could avoid calling ComputeCellOrigin
	...
	if (sqCapsuleRadiusUInt > 0)
	{
		...
		{
			// the first halfEdge to be crossed has not be crossed (dest is in start triangle), check it is compatible with margin
			if (queryUtils.IsHalfEdgeCompatibleWithThinCapsule<TLogic>(currentHalfEdgeRawPtrToCross, capsuleParams) == false)
			{
				SetResult(RAYCANGO_DONE_BORDER_DETECTED_WITHIN_MARGIN);
				return;
