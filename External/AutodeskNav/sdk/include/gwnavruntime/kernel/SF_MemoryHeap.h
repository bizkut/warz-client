...
#ifndef INC_KY_Kernel_MemoryHeap_H
#define INC_KY_Kernel_MemoryHeap_H
...
// of system memory; this interface is specified in Kaim::System constructor.
...
public:
    ...
    //
    //--------------------------------------------------------------------
    static void KY_STDCALL InitPT(SysAllocPaged* sysAlloc);
    static void KY_STDCALL InitMH(SysAlloc* sysAllocMH);
    static void KY_STDCALL CleanUpPT();
    static void KY_STDCALL CleanUpMH();
    ...
    // another root heap.
    static MemoryHeap* KY_STDCALL CreateRootHeapPT();
    static MemoryHeap* KY_STDCALL CreateRootHeapMH();
    static MemoryHeap* KY_STDCALL CreateRootHeapPT(const HeapDesc& desc);
    static MemoryHeap* KY_STDCALL CreateRootHeapMH(const HeapDesc& desc);
    ...
    static void KY_STDCALL ReleaseRootHeapPT();
    static void KY_STDCALL ReleaseRootHeapMH();
    ...
    virtual void*   ReallocAutoHeap(void* oldPtr, UPInt newSize) { return Realloc(oldPtr, newSize); }
