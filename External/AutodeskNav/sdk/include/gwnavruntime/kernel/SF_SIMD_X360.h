...
#ifndef INC_KY_SF_SIMD_X360_H
#define INC_KY_SF_SIMD_X360_H
#pragma once

#if defined(KY_ENABLE_SIMD) && defined(KY_OS_XBOX360)

#include <VectorIntrinsics.h>
#define KY_SIMD_ALIGN(x) _DECLSPEC_ALIGN_16_ x
...
public:
    ...
    static int MoveMask( Vector4f r0 )
    {
        ...
        Vector4f t0 = __vcmpgefp(r0, __vzero());
        Vector4f t1 = __vpkswss(t0, t0);
        Vector4f t2 = __vpkswss(t1, t1);
...
#endif // KY_ENABLE_SIMD && KY_OS_XBOX360

#endif // INC_KY_SF_SIMD_X360_H
