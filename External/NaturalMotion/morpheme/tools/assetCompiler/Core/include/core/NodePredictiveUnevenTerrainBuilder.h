...
//----------------------------------------------------------------------------------------------------------------------
  ...
  #pragma once
#endif
#ifndef MR_NODE_PREDICTIVE_UNEVEN_TERRAIN_BUILDER_H
#define MR_NODE_PREDICTIVE_UNEVEN_TERRAIN_BUILDER_H
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
/// \class AP::NodePredictiveUnevenTerrainBuilder
/// \brief For construction of a basic uneven terrain character control node.
//----------------------------------------------------------------------------------------------------------------------
class NodePredictiveUnevenTerrainBuilder : public NodeDefBuilder
{
public:
  ...
  static void initPredictionDefAttrib(
    const ME::NodeExport*       nodeDefExport,
...
//----------------------------------------------------------------------------------------------------------------------
#endif // MR_NODE_PREDICTIVE_UNEVEN_TERRAIN_BUILDER_H
//----------------------------------------------------------------------------------------------------------------------
