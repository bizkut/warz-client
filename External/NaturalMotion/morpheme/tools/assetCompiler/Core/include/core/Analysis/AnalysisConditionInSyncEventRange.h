...
#pragma once
#endif
#ifndef AP_ANALYSIS_CONDITION_IN_SYNC_EVENT_RANGE_H
#define AP_ANALYSIS_CONDITION_IN_SYNC_EVENT_RANGE_H
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
/// \class AnalysisConditionInSyncEventRange
//----------------------------------------------------------------------------------------------------------------------
class AnalysisConditionInSyncEventRange : public AnalysisCondition
{
public:
  // Definition data
  MR::AttribAddress m_sourceNodeSyncEventPlaybackPosAddress; ///< Address of the sync event playback pos attrib of the source node of the transition.
  MR::AttribAddress m_sourceNodeSyncEventTrackAddress;       ///< Address of the sync event track attrib of the source node of the transition.
  float             m_eventRangeStart;                       ///< Event index and fraction.
  float             m_eventRangeEnd;                         ///< Event index and fraction.
};

//----------------------------------------------------------------------------------------------------------------------
/// \class AnalysisConditionUserDataEventBuilder
//----------------------------------------------------------------------------------------------------------------------
class AnalysisConditionInSyncEventRangeBuilder : public AnalysisConditionBuilder
{
public:
...
//----------------------------------------------------------------------------------------------------------------------
#endif // AP_ANALYSIS_CONDITION_IN_SYNC_EVENT_RANGE_H
//----------------------------------------------------------------------------------------------------------------------
