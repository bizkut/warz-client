...
#pragma once
#endif
#ifndef AP_ANALYSIS_PROPERTY_STRIDE_LENGTH_H
#define AP_ANALYSIS_PROPERTY_STRIDE_LENGTH_H
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
/// \class AnalysisPropertyStrideLength
//----------------------------------------------------------------------------------------------------------------------
class AnalysisPropertyStrideLength : public AnalysisProperty
{
public:
  typedef enum
  {
  ...
  // Extracted features
  AnalysisPropertySyncEventWatchBuffer* m_syncEventWatchBuffer;
  AnalysisPropertySampleBuffer*   m_sampleBuffer;
};

//----------------------------------------------------------------------------------------------------------------------
/// \class AnalysisPropertyStrideLengthBuilder
//----------------------------------------------------------------------------------------------------------------------
class AnalysisPropertyStrideLengthBuilder : public AnalysisPropertyBuilder
{
public:
  ...
  static uint32_t readSyncEventRange(
...
//----------------------------------------------------------------------------------------------------------------------
#endif // AP_ANALYSIS_PROPERTY_STRIDE_LENGTH_H
//----------------------------------------------------------------------------------------------------------------------
