...
#pragma once
#endif
#ifndef AP_ANALYSIS_PROPERTY_POSITION_VALUE_IN_AXIS_H
#define AP_ANALYSIS_PROPERTY_POSITION_VALUE_IN_AXIS_H
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
/// \class AnalysisPropertyPositionValueInAxis
//----------------------------------------------------------------------------------------------------------------------
class AnalysisPropertyPositionValueInAxis : public AnalysisProperty
{
public:
  typedef enum
  {
    kAPOperationMin           = 0,
    kAPOperationMax           = 1,
    kAPOperationAverage       = 2,
    kAPOperationMedian        = 3,
    kAPNumOperations,
    kAPInvalidOperation       = 0xFFFFFFFF
  } AnalysisOperation;


  // Definition data
  AnalysisOperation               m_operation;
  AnalysisPropertyAxis            m_axis;
  bool                            m_flipAxisDirection;
...
//----------------------------------------------------------------------------------------------------------------------
/// \class AnalysisPropertyPositionValueInAxisBuilder
//----------------------------------------------------------------------------------------------------------------------
class AnalysisPropertyPositionValueInAxisBuilder : public AnalysisPropertyBuilder
{
public:
...
//----------------------------------------------------------------------------------------------------------------------
#endif // AP_ANALYSIS_PROPERTY_POSITION_VALUE_IN_AXIS_H
//----------------------------------------------------------------------------------------------------------------------
