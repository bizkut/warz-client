...
#pragma once
#endif
#ifndef MR_NODE_OPERATOR_FLOAT_TO_INT_BUILDER_H
#define MR_NODE_OPERATOR_FLOAT_TO_INT_BUILDER_H
//----------------------------------------------------------------------------------------------------------------------
...
namespace AP
{
  ...
  //----------------------------------------------------------------------------------------------------------------------
  /// \class AP::NodeOperatorFloatToIntBuilder
  /// \brief For construction of NodeOperatorFloatsToInt.
  //----------------------------------------------------------------------------------------------------------------------
  class NodeOperatorFloatToIntBuilder : public NodeDefBuilder
  {
  public:
...
//----------------------------------------------------------------------------------------------------------------------
#endif // MR_NODE_OPERATOR_FLOAT_TO_INT_BUILDER_H
//----------------------------------------------------------------------------------------------------------------------
