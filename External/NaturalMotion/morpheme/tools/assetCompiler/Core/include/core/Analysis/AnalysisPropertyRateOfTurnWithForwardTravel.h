...
#pragma once
#endif
#ifndef AP_ANALYSIS_PROPERTY_RATEOFTURN_WITH_FORWARD_TRAVEL_H
#define AP_ANALYSIS_PROPERTY_RATEOFTURN_WITH_FORWARD_TRAVEL_H
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
/// \class AnalysisPropertyRateOfTurnWithForwardTravel
//----------------------------------------------------------------------------------------------------------------------
class AnalysisPropertyRateOfTurnWithForwardTravel : public AnalysisProperty
{
public:
  // Definition data
  AnalysisPropertyAxis            m_turnAxis;
  AnalysisPropertyAxis            m_facingDirection;
  bool                            m_flipTurnAxisDirection;
  bool                            m_flipFacingDirection;

  // Extracted features
  AnalysisPropertySampleBuffer*   m_sampleBuffer;
  AnalysisPropertyDataModel*      m_dataModel;
  AnalysisPropertySubRange*       m_subRange;
};

//----------------------------------------------------------------------------------------------------------------------
/// \class AnalysisPropertyRateOfTurnWithForwardTravelBuilder
//----------------------------------------------------------------------------------------------------------------------
class AnalysisPropertyRateOfTurnWithForwardTravelBuilder : public AnalysisPropertyBuilder
{
public:
...
//----------------------------------------------------------------------------------------------------------------------
#endif // AP_ANALYSIS_PROPERTY_RATEOFTURN_WITH_FORWARD_TRAVEL_H
//----------------------------------------------------------------------------------------------------------------------
