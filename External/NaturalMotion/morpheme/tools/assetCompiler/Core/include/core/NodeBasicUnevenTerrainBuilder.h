...
//----------------------------------------------------------------------------------------------------------------------
  ...
  #pragma once
#endif
#ifndef MR_NODE_BASIC_UNEVEN_TERRAIN_BUILDER_H
#define MR_NODE_BASIC_UNEVEN_TERRAIN_BUILDER_H
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
/// \class AP::NodeBasicUnevenTerrainBuilder
/// \brief For construction of a basic uneven terrain character control node.
//----------------------------------------------------------------------------------------------------------------------
class NodeBasicUnevenTerrainBuilder : public NodeDefBuilder
{
public:
  ...
  static void initSetupAttrib(
    const ME::NodeExport*                   nodeDefExport,
    MR::AttribDataBasicUnevenTerrainSetup*  setupAttrib);

  static void initChainAttrib(
    const ME::NodeExport*                   nodeDefExport,
...
//----------------------------------------------------------------------------------------------------------------------
#endif // MR_NODE_BASIC_UNEVEN_TERRAIN_BUILDER_H
//----------------------------------------------------------------------------------------------------------------------
