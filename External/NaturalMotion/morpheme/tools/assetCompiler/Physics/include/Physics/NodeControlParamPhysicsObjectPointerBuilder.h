...
//----------------------------------------------------------------------------------------------------------------------
  ...
  #pragma once
#endif
#ifndef MR_NODE_CONTROL_PARAM_PHYSICS_OBJECT_POINTER_BUILDER_H
#define MR_NODE_CONTROL_PARAM_PHYSICS_OBJECT_POINTER_BUILDER_H
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
/// \class AP::NodeControlParamPhysicsObjectPointerBuilder
/// \brief For construction of NodeControlParamPhysicsObjectPointer
/// \ingroup
//----------------------------------------------------------------------------------------------------------------------
class NodeControlParamPhysicsObjectPointerBuilder : public NodeDefBuilder
{
public:
...
private:
  ...
  void initTaskQueuingFns(
    MR::NodeDef*                nodeDef,
    NetworkDefCompilationInfo*  netDefBuilderData,
...
//----------------------------------------------------------------------------------------------------------------------
#endif // MR_NODE_CONTROL_PARAM_PHYSICS_OBJECT_POINTER_BUILDER_H
//----------------------------------------------------------------------------------------------------------------------
