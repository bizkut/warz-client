...
//----------------------------------------------------------------------------------------------------------------------
  ...
  #pragma once
#endif
#ifndef MR_TRANSIT_CONDITION_CONTROL_PARAM_UINT_GREATER_H
#define MR_TRANSIT_CONDITION_CONTROL_PARAM_UINT_GREATER_H
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
/// \class MR::TransitConditionDefControlParamUIntGreater
/// \brief Transition condition definition for TransitConditionDefControlParamUIntGreater.
/// \ingroup NodesLibraryTransitConditionsModule
/// \see MR::TransitConditionDef
//----------------------------------------------------------------------------------------------------------------------
class TransitConditionDefControlParamUIntGreater : public TransitConditionDef
{
public:
...
protected:
  TransitConditionDefControlParamUIntGreater() { m_type = TRANSCOND_CONTROL_PARAM_UINT_GREATER_ID; };
...
//----------------------------------------------------------------------------------------------------------------------
/// \class MR::TransitConditionControlParamUIntGreater
/// \brief Condition satisfied when UInt Control Parameter value is greater than our test value.
/// \ingroup NodesLibraryTransitConditionsModule
/// \see MR::TransitCondition
//----------------------------------------------------------------------------------------------------------------------
class TransitConditionControlParamUIntGreater : public TransitCondition
{
  friend class TransitConditionDefControlParamUIntGreater;

protected:
  TransitConditionControlParamUIntGreater();
  ~TransitConditionControlParamUIntGreater();
};
...
//----------------------------------------------------------------------------------------------------------------------
#endif // MR_TRANSIT_CONDITION_CONTROL_PARAM_UINT_GREATER_H
//----------------------------------------------------------------------------------------------------------------------
