...
//----------------------------------------------------------------------------------------------------------------------
  ...
  #pragma once
#endif
#ifndef MR_TRANSIT_CONDITION_CONTROL_PARAM_FLOAT_GREATER_H
#define MR_TRANSIT_CONDITION_CONTROL_PARAM_FLOAT_GREATER_H
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
/// \class MR::TransitConditionDefControlParamFloatGreater
/// \brief Transition condition definition for TransitConditionControlParamFloatGreater.
...
protected:
  TransitConditionDefControlParamFloatGreater() { m_type = TRANSCOND_CONTROL_PARAM_FLOAT_GREATER_ID; };
...
//----------------------------------------------------------------------------------------------------------------------
/// \class MR::TransitConditionControlParamFloatGreater
/// \brief Condition satisfied when Float Control Parameter value is greater than our test value.
/// \ingroup NodesLibraryTransitConditionsModule
/// \see MR::TransitCondition
//----------------------------------------------------------------------------------------------------------------------
class TransitConditionControlParamFloatGreater : public TransitCondition
{
  friend class TransitConditionDefControlParamFloatGreater;

protected:
  TransitConditionControlParamFloatGreater();
  ~TransitConditionControlParamFloatGreater();
};
