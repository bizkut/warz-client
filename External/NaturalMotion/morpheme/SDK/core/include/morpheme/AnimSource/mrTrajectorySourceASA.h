...
//----------------------------------------------------------------------------------------------------------------------
  ...
  #pragma once
#endif
#ifndef MR_TRAJECTORY_SOURCE_ASA_H
#define MR_TRAJECTORY_SOURCE_ASA_H
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
class TrajectorySourceASA : public TrajectorySourceBase
{
public:
  TrajectorySourceASA() {}
  ~TrajectorySourceASA() {}
...
protected:
  ...
  ChannelSetASAInfo m_deltaTrajectoryInfo;        ///< Contains default information about the delta trajectory channel
  ChannelSetASA     m_deltaTrajectoryChannelSet;  ///< Each key frames records the offset from the first frame of
                                                  ///< this channel.
};
...
//----------------------------------------------------------------------------------------------------------------------
#endif // MR_TRAJECTORY_SOURCE_ASA_H
//----------------------------------------------------------------------------------------------------------------------
