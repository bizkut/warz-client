...
#ifndef NM_MDF_LEGREACHREACTION_DATA_H
#define NM_MDF_LEGREACHREACTION_DATA_H
...
/** 
 * \class LegReachReactionInputs
 * \ingroup LegReachReaction
 * \brief Inputs looks at the specified target
 *
 * Data packet definition (80 bytes, 96 aligned)
 */
NMP_ALIGN_PREFIX(32) struct LegReachReactionInputs
{
  NM_INLINE void clear()
  {
    memset(this, 0, sizeof(LegReachReactionInputs));
  }
...
protected:
  ...
  friend class LegReachReaction_Con;
...
//----------------------------------------------------------------------------------------------------------------------
/** 
 * \class LegReachReactionOutputs
 * \ingroup LegReachReaction
 * \brief Outputs looks at the specified target
 *
 * Data packet definition (388 bytes, 416 aligned)
 */
NMP_ALIGN_PREFIX(32) struct LegReachReactionOutputs
{
  NM_INLINE void clear()
  {
    memset(this, 0, sizeof(LegReachReactionOutputs));
  }
...
#endif // NM_MDF_LEGREACHREACTION_DATA_H
