...
//----------------------------------------------------------------------------------------------------------------------
void SpineReachReaction_Con::create(ER::Module* module, ER::Module* NMP_UNUSED(owner))
{
  buildConnections((SpineReachReaction*)module);
}

//----------------------------------------------------------------------------------------------------------------------
SpineReachReaction_Con::~SpineReachReaction_Con()
{
...
//----------------------------------------------------------------------------------------------------------------------
NMP::Memory::Format SpineReachReaction_Con::getMemoryRequirements()
{
  NMP::Memory::Format result(sizeof(SpineReachReaction_Con), 16);
...
//----------------------------------------------------------------------------------------------------------------------
void SpineReachReaction_Con::buildConnections(SpineReachReaction* module)
{
  // Reconstruct the previously-allocated resource to fill in the junctions
  NMP::Memory::Format format = getMemoryRequirements();
  NMP::Memory::Resource resource = {this, format};
  NMP::Memory::Format classFormat(sizeof(SpineReachReaction_Con), 16);
...
//----------------------------------------------------------------------------------------------------------------------
void SpineReachReaction_Con::relocate()
{
  // Reconstruct the previously-allocated resource to fill in the junctions
  NMP::Memory::Format format = getMemoryRequirements();
  NMP::Memory::Resource resource = {this, format};
...
//----------------------------------------------------------------------------------------------------------------------
// Combiner api.
void SpineReachReaction_Con::combineInputs(ER::Module* modulePtr)
{
  SpineReachReaction* module = (SpineReachReaction*)modulePtr;
  SpineReachReactionInputs& in = *module->in;
