...
#ifndef NM_MDF_LEGSTANDINGSUPPORT_DATA_H
#define NM_MDF_LEGSTANDINGSUPPORT_DATA_H
...
/** 
 * \class LegStandingSupportData
 * \ingroup LegStandingSupport
 * \brief Data Maintain a raised stance of the body relative to the ground, this module controls the position of the pelvis.
 *
 * Data packet definition (2 bytes, 32 aligned)
 */
NMP_ALIGN_PREFIX(32) struct LegStandingSupportData
{
  NM_INLINE void clear()
  {
    memset(this, 0, sizeof(LegStandingSupportData));
  }
...
//----------------------------------------------------------------------------------------------------------------------
/** 
 * \class LegStandingSupportInputs
 * \ingroup LegStandingSupport
 * \brief Inputs Maintain a raised stance of the body relative to the ground, this module controls the position of the pelvis.
 *
 * Data packet definition (313 bytes, 320 aligned)
 */
NMP_ALIGN_PREFIX(32) struct LegStandingSupportInputs
{
  NM_INLINE void clear()
  {
    memset(this, 0, sizeof(LegStandingSupportInputs));
  }
...
protected:
  ...
  friend class LegStandingSupport_Con;
...
//----------------------------------------------------------------------------------------------------------------------
/** 
 * \class LegStandingSupportOutputs
 * \ingroup LegStandingSupport
 * \brief Outputs Maintain a raised stance of the body relative to the ground, this module controls the position of the pelvis.
 *
 * Data packet definition (393 bytes, 416 aligned)
 */
NMP_ALIGN_PREFIX(32) struct LegStandingSupportOutputs
{
  NM_INLINE void clear()
  {
    memset(this, 0, sizeof(LegStandingSupportOutputs));
  }
...
//----------------------------------------------------------------------------------------------------------------------
/** 
 * \class LegStandingSupportFeedbackOutputs
 * \ingroup LegStandingSupport
 * \brief FeedbackOutputs Maintain a raised stance of the body relative to the ground, this module controls the position of the pelvis.
 *
 * Data packet definition (49 bytes, 64 aligned)
 */
NMP_ALIGN_PREFIX(32) struct LegStandingSupportFeedbackOutputs
{
  NM_INLINE void clear()
  {
    memset(this, 0, sizeof(LegStandingSupportFeedbackOutputs));
  }
  ...
  NM_INLINE void setPelvisControlAmount(const float& _pelvisControlAmount, float pelvisControlAmount_importance = 1.f)
  {
    pelvisControlAmount = _pelvisControlAmount;
    postAssignPelvisControlAmount(pelvisControlAmount);
    NMP_ASSERT(pelvisControlAmount_importance >= 0.0f && pelvisControlAmount_importance <= 1.0f);
    m_pelvisControlAmountImportance = pelvisControlAmount_importance;
  }
  NM_INLINE float getPelvisControlAmountImportance() const { return m_pelvisControlAmountImportance; }
  NM_INLINE const float& getPelvisControlAmountImportanceRef() const { return m_pelvisControlAmountImportance; }
  NM_INLINE const float& getPelvisControlAmount() const { return pelvisControlAmount; }
...
protected:
  ...
  float pelvisControlAmount;  ///< How much chest control due to arm strength, 0 up to 1 if arm can control chest with normal stiffness  (WeightWithClamp)
  ...
  NM_INLINE void postAssignPelvisControlAmount(const float& NMP_VALIDATOR_ARG(v)) const
  {
#if NM_CALL_VALIDATORS
    NM_VALIDATOR(Float0to1(v), "pelvisControlAmount");
#endif // NM_CALL_VALIDATORS
  }
  ...
  float
     ...
     m_pelvisControlAmountImportance, 
...
public:
  ...
  NM_INLINE void validate() const
  {
    ...
    if (getPelvisControlAmountImportance() > 0.0f)
    {
      NM_VALIDATOR(Float0to1(pelvisControlAmount), "pelvisControlAmount");
    }
...
#endif // NM_MDF_LEGSTANDINGSUPPORT_DATA_H
