...
#ifndef NM_MDF_POSITIONCORE_H
#define NM_MDF_POSITIONCORE_H
...
class PositionCore : public ER::Module
{
public:

  PositionCore(ER::ModuleDataAllocator* mdAllocator, ER::ModuleCon* connectionSet);
  virtual ~PositionCore();
  ...
  virtual const char* getClassName() const  NM_OVERRIDE { return "PositionCore"; }

  virtual bool storeState(MR::PhysicsSerialisationBuffer& savedState) NM_OVERRIDE;
  virtual bool restoreState(MR::PhysicsSerialisationBuffer& savedState) NM_OVERRIDE;

  // module data blocks
  PositionCoreFeedbackInputs* feedIn;
  PositionCoreInputs* in;
  PositionCoreFeedbackOutputs* feedOut;
  PositionCoreOutputs* out;
  ...
  // Module packaging
  PositionCoreAPIBase* m_apiBase;
  PositionCoreUpdatePackage* m_updatePackage;
  PositionCoreFeedbackPackage* m_feedbackPackage;

  static NM_INLINE NMP::Memory::Format getMemoryRequirements()
  {
    NMP::Memory::Format result(sizeof(PositionCore), NMP_VECTOR_ALIGNMENT);
    return result;
  }
};

//----------------------------------------------------------------------------------------------------------------------
class PositionCore_Con : public ER::ModuleCon
{
public:

  virtual ~PositionCore_Con();
  static NMP::Memory::Format getMemoryRequirements();

  virtual void create(ER::Module* module, ER::Module* owner) NM_OVERRIDE;
  virtual void buildConnections(PositionCore* module);
  void relocate();
