...
//----------------------------------------------------------------------------------------------------------------------
void HeadAim_Con::create(ER::Module* module, ER::Module* NMP_UNUSED(owner))
{
  buildConnections((HeadAim*)module);
}

//----------------------------------------------------------------------------------------------------------------------
HeadAim_Con::~HeadAim_Con()
{
...
//----------------------------------------------------------------------------------------------------------------------
NMP::Memory::Format HeadAim_Con::getMemoryRequirements()
{
  NMP::Memory::Format result(sizeof(HeadAim_Con), 16);
...
//----------------------------------------------------------------------------------------------------------------------
void HeadAim_Con::buildConnections(HeadAim* module)
{
  // Reconstruct the previously-allocated resource to fill in the junctions
  NMP::Memory::Format format = getMemoryRequirements();
  NMP::Memory::Resource resource = {this, format};
  NMP::Memory::Format classFormat(sizeof(HeadAim_Con), 16);
  ...
  activeJnc->getEdges()[0].reinit( (char*)&(module->owner->owner->aimBehaviourInterface->out->getHeadAimInfo(module->owner->getChildIndex())), (float*)&(module->owner->owner->aimBehaviourInterface->out->getHeadAimInfoImportanceRef(module->owner->getChildIndex())) );
...
void HeadAim_Con::relocate()
{
  ...
  // junc_in_aimInfo->getEdges()[0].reinit( (char*)&(module->owner->owner->aimBehaviourInterface->out->getHeadAimInfo(module->owner->getChildIndex())), (float*)&(module->owner->owner->aimBehaviourInterface->out->getHeadAimInfoImportanceRef(module->owner->getChildIndex())) );
...
//----------------------------------------------------------------------------------------------------------------------
// Combiner api.
void HeadAim_Con::combineInputs(ER::Module* modulePtr)
{
  HeadAim* module = (HeadAim*)modulePtr;
  HeadAimInputs& in = *module->in;
