...
#ifndef NM_MDF_RANDOMLOOK_H
#define NM_MDF_RANDOMLOOK_H
...
class RandomLook : public ER::Module
{
public:

  RandomLook(ER::ModuleDataAllocator* mdAllocator, ER::ModuleCon* connectionSet);
  virtual ~RandomLook();
  ...
  virtual const char* getClassName() const  NM_OVERRIDE { return "RandomLook"; }
  ...
  // module data blocks
  RandomLookData* data;
  RandomLookFeedbackInputs* feedIn;
  RandomLookInputs* in;
  RandomLookOutputs* out;
  ...
  // Module packaging
  RandomLookAPIBase* m_apiBase;
  RandomLookUpdatePackage* m_updatePackage;
  RandomLookFeedbackPackage* m_feedbackPackage;

  static NM_INLINE NMP::Memory::Format getMemoryRequirements()
  {
    NMP::Memory::Format result(sizeof(RandomLook), NMP_VECTOR_ALIGNMENT);
    return result;
  }
};

//----------------------------------------------------------------------------------------------------------------------
class RandomLook_Con : public ER::ModuleCon
{
public:

  virtual ~RandomLook_Con();
  static NMP::Memory::Format getMemoryRequirements();

  virtual void create(ER::Module* module, ER::Module* owner) NM_OVERRIDE;
  virtual void buildConnections(RandomLook* module);
  void relocate();
