...
#ifndef NM_MDF_ARMSTEP_DATA_H
#define NM_MDF_ARMSTEP_DATA_H
 ...
 * \class ArmStepData
 * \ingroup ArmStep
 * \brief Data Make the arm move to prepare to support the chest
 *
 * Data packet definition (139 bytes, 160 aligned)
 */
NMP_ALIGN_PREFIX(32) struct ArmStepData
{
  NM_INLINE void clear()
  {
    memset(this, 0, sizeof(ArmStepData));
  }
 ...
 * \class ArmStepInputs
 * \ingroup ArmStep
 * \brief Inputs Make the arm move to prepare to support the chest
 *
 * Data packet definition (527 bytes, 544 aligned)
 */
NMP_ALIGN_PREFIX(32) struct ArmStepInputs
{
  NM_INLINE void clear()
  {
    memset(this, 0, sizeof(ArmStepInputs));
  }
...
protected:
  ...
  NMP::Matrix34 recoveryStepTarget;          ///< (Transform)
  NMP::Matrix34 standingPoseEndRelativeToSupport[NetworkConstants::networkMaxNumArms];  ///< (Transform)
  ...
  float
     ...
     m_standingPoseEndRelativeToSupportImportance[NetworkConstants::networkMaxNumArms], 
...
//----------------------------------------------------------------------------------------------------------------------
/** 
 * \class ArmStepOutputs
 * \ingroup ArmStep
 * \brief Outputs Make the arm move to prepare to support the chest
 *
 * Data packet definition (393 bytes, 416 aligned)
 */
NMP_ALIGN_PREFIX(32) struct ArmStepOutputs
{
  NM_INLINE void clear()
  {
    memset(this, 0, sizeof(ArmStepOutputs));
  }
...
//----------------------------------------------------------------------------------------------------------------------
/** 
 * \class ArmStepFeedbackOutputs
 * \ingroup ArmStep
 * \brief FeedbackOutputs Make the arm move to prepare to support the chest
 *
 * Data packet definition (59 bytes, 64 aligned)
 */
NMP_ALIGN_PREFIX(32) struct ArmStepFeedbackOutputs
{
  NM_INLINE void clear()
  {
    memset(this, 0, sizeof(ArmStepFeedbackOutputs));
  }
