...
#ifndef NM_MDF_ARMBRACE_H
#define NM_MDF_ARMBRACE_H
...
class ArmBrace : public ER::Module
{
public:

  ArmBrace(ER::ModuleDataAllocator* mdAllocator, ER::ModuleCon* connectionSet);
  virtual ~ArmBrace();
  ...
  virtual const char* getClassName() const  NM_OVERRIDE { return "ArmBrace"; }
  ...
  // module data blocks
  ArmBraceData* data;
  ArmBraceFeedbackInputs* feedIn;
  ArmBraceInputs* in;
  ArmBraceFeedbackOutputs* feedOut;
  ArmBraceOutputs* out;
  ...
  // Module packaging
  ArmBraceAPIBase* m_apiBase;
  ArmBraceUpdatePackage* m_updatePackage;
  ArmBraceFeedbackPackage* m_feedbackPackage;

  static NM_INLINE NMP::Memory::Format getMemoryRequirements()
  {
    NMP::Memory::Format result(sizeof(ArmBrace), NMP_VECTOR_ALIGNMENT);
    return result;
  }
};

//----------------------------------------------------------------------------------------------------------------------
class ArmBrace_Con : public ER::ModuleCon
{
public:

  virtual ~ArmBrace_Con();
  static NMP::Memory::Format getMemoryRequirements();

  virtual void create(ER::Module* module, ER::Module* owner) NM_OVERRIDE;
  virtual void buildConnections(ArmBrace* module);
  void relocate();
