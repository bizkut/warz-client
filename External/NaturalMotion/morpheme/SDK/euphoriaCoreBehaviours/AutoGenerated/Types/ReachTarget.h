...
#ifndef NM_MDF_TYPE_REACHTARGET_H
#define NM_MDF_TYPE_REACHTARGET_H
...
struct ReachTarget
{
  ...
  float elapsedTime;  /// set to zero when the selection is made, can be incremented at each tick while it persists  (TimePeriod)
...
#endif // NM_MDF_TYPE_REACHTARGET_H
