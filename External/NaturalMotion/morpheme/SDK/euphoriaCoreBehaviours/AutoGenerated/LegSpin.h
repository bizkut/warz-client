...
#ifndef NM_MDF_LEGSPIN_H
#define NM_MDF_LEGSPIN_H
...
class LegSpin : public ER::Module
{
public:

  LegSpin(ER::ModuleDataAllocator* mdAllocator, ER::ModuleCon* connectionSet);
  virtual ~LegSpin();
  ...
  virtual const char* getClassName() const  NM_OVERRIDE { return "LegSpin"; }
  ...
  LegSpinData* data;
  LegSpinInputs* in;
  LegSpinFeedbackOutputs* feedOut;
  LegSpinOutputs* out;
  ...
  // Module packaging
  LegSpinAPIBase* m_apiBase;
  LegSpinUpdatePackage* m_updatePackage;
  LegSpinFeedbackPackage* m_feedbackPackage;

  static NM_INLINE NMP::Memory::Format getMemoryRequirements()
  {
    NMP::Memory::Format result(sizeof(LegSpin), NMP_VECTOR_ALIGNMENT);
    return result;
  }
};

//----------------------------------------------------------------------------------------------------------------------
class LegSpin_Con : public ER::ModuleCon
{
public:
  ...
  virtual void buildConnections(LegSpin* module);
  void relocate();
