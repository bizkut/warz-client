...
#ifndef NM_MDF_ARMWRITHE_DATA_H
#define NM_MDF_ARMWRITHE_DATA_H
 ...
 */
NMP_ALIGN_PREFIX(32) struct ArmWritheData
{
  NM_INLINE void clear()
  {
    memset(this, 0, sizeof(ArmWritheData));
  }
