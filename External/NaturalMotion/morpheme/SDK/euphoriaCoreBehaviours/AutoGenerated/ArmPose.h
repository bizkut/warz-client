...
#ifndef NM_MDF_ARMPOSE_H
#define NM_MDF_ARMPOSE_H
...
class ArmPose : public ER::Module
{
public:

  ArmPose(ER::ModuleDataAllocator* mdAllocator, ER::ModuleCon* connectionSet);
  virtual ~ArmPose();
  ...
  virtual const char* getClassName() const  NM_OVERRIDE { return "ArmPose"; }
  ...
  // Module packaging
  ArmPoseAPIBase* m_apiBase;
  ArmPoseUpdatePackage* m_updatePackage;
  ArmPoseFeedbackPackage* m_feedbackPackage;

  static NM_INLINE NMP::Memory::Format getMemoryRequirements()
  {
    NMP::Memory::Format result(sizeof(ArmPose), NMP_VECTOR_ALIGNMENT);
    return result;
  }
};

//----------------------------------------------------------------------------------------------------------------------
class ArmPose_Con : public ER::ModuleCon
{
public:
  ...
  virtual void buildConnections(ArmPose* module);
  void relocate();
