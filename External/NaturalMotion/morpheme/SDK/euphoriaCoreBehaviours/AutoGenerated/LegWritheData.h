...
#ifndef NM_MDF_LEGWRITHE_DATA_H
#define NM_MDF_LEGWRITHE_DATA_H
 ...
 */
NMP_ALIGN_PREFIX(32) struct LegWritheData
{
  NM_INLINE void clear()
  {
    memset(this, 0, sizeof(LegWritheData));
  }
