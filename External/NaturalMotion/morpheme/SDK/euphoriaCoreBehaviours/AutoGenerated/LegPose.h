...
#ifndef NM_MDF_LEGPOSE_H
#define NM_MDF_LEGPOSE_H
...
class LegPose : public ER::Module
{
public:

  LegPose(ER::ModuleDataAllocator* mdAllocator, ER::ModuleCon* connectionSet);
  virtual ~LegPose();
  ...
  virtual const char* getClassName() const  NM_OVERRIDE { return "LegPose"; }
  ...
  // Module packaging
  LegPoseAPIBase* m_apiBase;
  LegPoseUpdatePackage* m_updatePackage;
  LegPoseFeedbackPackage* m_feedbackPackage;

  static NM_INLINE NMP::Memory::Format getMemoryRequirements()
  {
    NMP::Memory::Format result(sizeof(LegPose), NMP_VECTOR_ALIGNMENT);
    return result;
  }
};

//----------------------------------------------------------------------------------------------------------------------
class LegPose_Con : public ER::ModuleCon
{
public:
  ...
  virtual void buildConnections(LegPose* module);
  void relocate();
