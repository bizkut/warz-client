...
#include "LiveLinkEuphoriaDataManager.h"
...
//----------------------------------------------------------------------------------------------------------------------
/// LiveLinkEuphoriaDataManager
//----------------------------------------------------------------------------------------------------------------------
LiveLinkEuphoriaDataManager::LiveLinkEuphoriaDataManager(MCOMMS::LiveLinkNetworkManager* networkManager) :
...
//----------------------------------------------------------------------------------------------------------------------
MR::Network* LiveLinkEuphoriaDataManager::findNetworkByInstanceID(MCOMMS::InstanceID id) const
{
  const char* name = 0;
  MR::Network* network = m_networkManager->findNetworkByInstanceID(id, name);
  return network;
}

//----------------------------------------------------------------------------------------------------------------------
MR::NetworkDef* LiveLinkEuphoriaDataManager::findNetworkDefByGuid(const MCOMMS::GUID& networkGUID) const
{
  MR::NetworkDef* networkDef = m_networkManager->findNetworkDefByGuid(networkGUID);
  return networkDef;
}
