...
//----------------------------
bool AssetLoaderBasic::validatePluginList(const NMP::OrderedStringTable& pluginList)
{
  ...
  // The GameAnimModule has the core and the physics library registered.  If the asset contains the physics plug-in then
