...
public:
  ...
  // simply fixes up the objects in-place, inside the bundle. This would be replaced with your own bundle loader and
  // unloader if you do not use the simple bundle file format.
  ...
  //----------------------------
  // This unloads the objects loaded in the loadBundle.
  ...
  //----------------------------
  // Validates the list of plugins that a bundle was built against the order that morpheme libraries are registered in
