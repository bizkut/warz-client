...
//----------------------------------------------------------------------------------------------------------------------
#if (!defined(NMTL_VECTOR_H) && !defined(NMTL_NO_SENTRY)) || defined(NMTL_NO_SENTRY)
#ifndef NMTL_NO_SENTRY
  #define NMTL_VECTOR_H
#endif
...
//----------------------------------------------------------------------------------------------------------------------
template<typename T>
class NMTL_TEMPLATE_EXPORT vector
{
public:
  //--------------------------------------------------------------------------------------
  // vector typedefs
  ...
  NMTL_INLINE vector(nmtl::allocator* allocator_ = NMTL_DEFAULT_ALLOCATOR) :
  ...
  NMTL_INLINE vector(const my_type& right) :
...
NMTL_INLINE bool operator ==(const vector<value_type>& lhs, const vector<value_type>& rhs)
{
  ...
  typename vector<value_type>::const_iterator ita = lhs.begin();
  typename vector<value_type>::const_iterator itb = rhs.begin();
