...
//----------------------------------------------------------------------------------------------------------------------
template <>
NonLinearOptimiserCholesky<ScalarType>::NonLinearOptimiserCholesky(NonLinearLeastSquaresFunc<ScalarType>& func) :
  NonLinearOptimiserBase<ScalarType>(func),
  m_solver(func.getNumUnknowns(), 1),
...
//----------------------------------------------------------------------------------------------------------------------
template <>
NonLinearOptimiserCholesky<ScalarType>::NonLinearOptimiserCholesky(NonLinearLeastSquaresFuncJac<ScalarType>& funcJac) :
  NonLinearOptimiserBase<ScalarType>(funcJac),
  m_solver(funcJac.getNumUnknowns(), 1),
...
//----------------------------------------------------------------------------------------------------------------------
template <>
NonLinearOptimiserCholesky<ScalarType>::~NonLinearOptimiserCholesky()
{
}

//----------------------------------------------------------------------------------------------------------------------
template <>
bool NonLinearOptimiserCholesky<ScalarType>::computeJByFiniteDifference(
...
//----------------------------------------------------------------------------------------------------------------------
template <>
void NonLinearOptimiserCholesky<ScalarType>::getJabsRowSums(
...
//----------------------------------------------------------------------------------------------------------------------
template <>
void NonLinearOptimiserCholesky<ScalarType>::computeJtr(
  uint32_t                             numResiduals,
  const NMP::JacobianBase<ScalarType>* J,
...
//----------------------------------------------------------------------------------------------------------------------
template <>
void NonLinearOptimiserCholesky<ScalarType>::computeJb(
  uint32_t                             numResiduals,
  const NMP::JacobianBase<ScalarType>* J,
...
//----------------------------------------------------------------------------------------------------------------------
template <>
void NonLinearOptimiserCholesky<ScalarType>::computeJtJ(
  uint32_t                             numResiduals,
  const NMP::JacobianBase<ScalarType>* J,
...
//----------------------------------------------------------------------------------------------------------------------
template <>
void NonLinearOptimiserCholesky<ScalarType>::augmentJtJ(NMP::HessianBase<ScalarType>* H, ScalarType lambda)
{
  NMP_ASSERT(H);
  NMP::Hessian<ScalarType>& Hess = static_cast< NMP::Hessian<ScalarType>& >(*H);
  NMP::Matrix<ScalarType>& AtA = Hess.getMatrix();
...
//----------------------------------------------------------------------------------------------------------------------
template <>
void NonLinearOptimiserCholesky<ScalarType>::solve(
