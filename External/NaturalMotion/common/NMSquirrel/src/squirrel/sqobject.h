...
/*lint -e1790 Base class has no non-destructor virtual functions*/
/*lint -e1923 macro could become const variable*/
/*lint -e1931 Constructor can be used for implicit conversions*/
...
struct SQWeakRef : public SQRefCounted
{
  void Release();
  SQObject _obj;
};
