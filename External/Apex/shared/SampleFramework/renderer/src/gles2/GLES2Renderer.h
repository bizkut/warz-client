...
class GLES2Renderer : public Renderer
{
	...
	private:
		...
		struct ShaderContextType {
			PxVec3		  m_eyePosition;
			PxVec3		  m_eyeDirection;
			PxVec3		  m_ambientColor;
			PxVec4		  m_fogColorAndDistance;
			PxVec3		  m_lightColor;
			PxVec3		  m_lightDirection;
			PxVec3		  m_lightPosition;
	...
	public:
		ShaderContextType& shaderContext() { return m_shaderContext; }
};
}
