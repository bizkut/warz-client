 ...
 */
#ifndef GXL_RENDERER_MESH_H
#define GXL_RENDERER_MESH_H
...
namespace SampleRenderer
{
	...
	class GXMRendererMesh : public RendererMesh
	{
	public:
		GXMRendererMesh(GXMRenderer &renderer, const RendererMeshDesc &desc);
		virtual ~GXMRendererMesh(void);
	...
	protected:
		void operator=(const GXMRendererMesh &){}

		Renderer& renderer() { return m_renderer; }

		void InitVertexRenderer();

	private:
		GXMRenderer &m_renderer;

		void*		mRendererIndexBuffer;

		mutable PxU16		mCurrentRendererIndexBufferSize;
		PxU16		mMaxVerts;	

		SceUID		mRendererIndexBufferUid;
	};
