...
/*!
\file
\brief classes NxUserRenderInstanceBuffer and NxApexRenderInstanceBufferData
*/
...
/**
\brief The instance buffer type
*/
class NxApexRenderInstanceBufferData : public NxApexRenderBufferData<NxRenderInstanceSemantic, NxRenderInstanceSemantic::Enum> {};
...
public:
	...
	*/
	virtual void writeBuffer(const physx::NxApexRenderInstanceBufferData& data, physx::PxU32 firstInstance, physx::PxU32 numInstances) = 0;
};
