...
public:
	...
	///set the pose of the sphere - this pose will modify the scale, orientation and position of the sphere
...
public:
	...
	///set the pose of the capsule - this pose will modify the scale, orientation and position of the capsule
	virtual void setPose(physx::PxMat44 pose) = 0;
...
public:
	...
	///set the pose of the box - this pose will modify the scale, orientation and position of the box
	virtual void setPose(physx::PxMat44 pose) = 0;
