...
*/
bool buildExplicitHierarchicalMeshFromRenderMeshAsset(physx::IExplicitHierarchicalMesh& iHMesh, const physx::NxRenderMeshAsset& renderMeshAsset);
...
*/
bool buildExplicitHierarchicalMeshFromDestructibleAsset(physx::IExplicitHierarchicalMesh& iHMesh, const physx::NxDestructibleAsset& destructibleAsset);
