...
public:
	...
	*/
#if NX_SDK_VERSION_MAJOR == 2
	virtual NxActor*				getChunkPhysXActor(physx::PxU32 index) = 0;
#elif NX_SDK_VERSION_MAJOR == 3
	virtual physx::PxRigidDynamic*	getChunkPhysXActor(physx::PxU32 index) = 0;
#endif
	...
	*/
	...
	/**
		...
		a scale component.
			index = the chunk index within the actor
	*/
	virtual const physx::PxMat44 	getChunkTM(physx::PxU32 index) const = 0;
	...
	*/
	virtual bool					setHitChunkTrackingParams(bool flushHistory, bool startTracking, physx::PxU32 trackingDepth) = 0;
