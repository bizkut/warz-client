...
/**
	NxColorVsVelocityModifier modifies the color constants associated with a particle
	depending on the velocity of the particle.
*/
class NxColorVsVelocityModifier : public NxModifierT<NxColorVsVelocityModifier>
{
public:
