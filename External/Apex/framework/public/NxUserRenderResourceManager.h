...
public:
	...
	*/
	...
	/** \brief Get the sprite texture data */
	virtual physx::PxU32 getSpriteTextureData(physx::PxU32 spriteCount, physx::PxU32 spriteSemanticsBitmap, NxUserRenderSpriteTextureDesc* textureDescArray)
	{
