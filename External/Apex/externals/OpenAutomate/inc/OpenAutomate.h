...
#  define OA_PLATFORM OA_PS3
#elif defined(SN_TARGET_PSP2)
#  define OA_PLATFORM OA_PSP2
#elif defined(PX_MOCHA)
#  define OA_PLATFORM OA_MOCHA
#elif defined(_XBOX)
#  define OA_PLATFORM OA_XBOX
#elif defined(ANDROID)
#  define OA_PLATFORM OA_ANDROID
#elif defined(LINUX)
#  define OA_PLATFORM OA_LINUX
#elif defined(__APPLE__)
#  define OA_PLATFORM OA_APPLE
#else
...
#if OA_PLATFORM == OA_WIN32 || OA_PLATFORM == OA_XBOX
#define OA_STRCPY_S(dest, len, src) strcpy_s(dest, len, src)
#else
#define OA_STRCPY_S(dest, len, src) strcpy(dest, src)
#endif
...
} __attribute__((packed)) oaNamedOption;
#else
} oaNamedOption;
#endif
typedef enum
