...
//
// special dynamic load version.
// copy-paste from original steam_api.h 
// with pointers instead of functions
// init with SteamAPI_LoadDynamic
//
...
extern int SteamAPI_LoadDynamic();
